  ...
  render () {
    return(
      <Layout>
        ...
        <section className="hero is-fullheight" style={{background: `url('${HeroImage}')`, backgroundSize: 'cover'}}>
          <a id="inicio"></a>
            <div className="hero-body">
              <div className="container center">
                <div className="has-text-centered">
                  <h1 className="title is-size-1 has-text-white hero-title has-text-weight-normal is-size-2-mobile">Vivero la Cima</h1>
